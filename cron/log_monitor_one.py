#!/usr/bin/env python3
"""
Log Monitor and Analysis Tool for Range Straddle Strategy
...
class StrategyLogAnalyzer:
    """Analyze strategy execution logs"""
    ...
    def __init__(self, log_dir=None):
        ...
        self.log_file = os.path.join(self.log_dir, 'range_straddle_strategy.log')
    ...
    def print_detailed_execution(self, execution_id):
        ...
        print("=" * 100)
        print(f"📋 DETAILED EXECUTION LOG - ID: {execution_id}")
        print("=" * 100)
    ...
    def analyze_condition_failures(self, num_executions=20):
        ...
        print("=" * 80)
        print("🔍 CONDITION FAILURE ANALYSIS")
        print("=" * 80)
    ...
    def tail_logs(self, num_lines=50):
        ...
        try:
            ...
            print("=" * 100)
            print(f"📜 LAST {num_lines} LOG LINES")
            print("=" * 100)
...
def main():
    parser = argparse.ArgumentParser(description='Strategy Log Monitor and Analyzer')
