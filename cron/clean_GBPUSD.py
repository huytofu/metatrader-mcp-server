...
# Configuration
SYMBOL = "GBPUSD"
TASK_NAME = "Position_Cleanup_GBPUSD"
...
def setup_logging():
    ...
    log_file = os.path.join(log_dir, 'cleanup_gbpusd.log')
    
    # Create logger
    logger = logging.getLogger('GBPUSDCleanup')
...
class GBPUSDCleanupTask:
    ...
    def get_gbpusd_positions(self):
        """Get open GBPUSD positions"""
        try:
    ...
    def get_gbpusd_pending_orders(self):
        """Get pending GBPUSD orders"""
        try:
    ...
    def run_cleanup(self):
        ...
        try:
            ...
            # Get open positions
            positions = self.get_gbpusd_positions()
...
def setup_windows_task():
    ...
    try:
        # Import the enhanced task setup function
...
def clean_GBPUSD():
    ...
    cleanup_task = GBPUSDCleanupTask()
