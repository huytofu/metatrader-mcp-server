...
# Configuration
SYMBOL = "CADUSD"
TASK_NAME = "Position_Cleanup_CADUSD"
...
def setup_logging():
    ...
    log_file = os.path.join(log_dir, 'cleanup_cadusd.log')
    
    # Create logger
    logger = logging.getLogger('CADUSDCleanup')
...
class CADUSDCleanupTask:
    ...
    def get_cadusd_positions(self):
        """Get open CADUSD positions"""
        try:
    ...
    def get_cadusd_pending_orders(self):
        """Get pending CADUSD orders"""
        try:
    ...
    def run_cleanup(self):
        ...
        try:
            ...
            # Get open positions
            positions = self.get_cadusd_positions()
            ...
            # Get pending orders
            pending_orders = self.get_cadusd_pending_orders()
...
def clean_CADUSD():
    ...
    cleanup_task = CADUSDCleanupTask()
